...
export const FinanceService = {
    ...
    expensePayments: (id) => api.get(`/admin/expenses/${id}/payments`),
    recordExpensePayment: (id, payload) => api.post(`/admin/expenses/${id}/payments`, payload),
    deleteExpensePayment: (expenseId, paymentId) => api.delete(`/admin/expenses/${expenseId}/payments/${paymentId}`),

    ownerEquityEntries: (params = {}) => api.get('/admin/owner-equity', { params }),
