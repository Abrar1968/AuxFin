        ...
        <header class="rounded-2xl border border-slate-200 bg-white p-5">
            <div class="flex flex-wrap items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-600">
                        Complete walkthrough for each admin section with working flow, demo inputs, expected outputs, and financial equation examples.
                    </p>
                </div>
            ...
            <div class="mt-4 grid gap-3 md:grid-cols-3">
                <div class="rounded-lg bg-slate-100 p-3 text-sm">
                    ...
                    <p class="mt-1 text-slate-600">Use the listed workflow before entering demo values to keep data integrity.</p>
                </div>
                <div class="rounded-lg bg-slate-100 p-3 text-sm">
                    <p class="font-semibold text-slate-800">2. Validate Outputs</p>
                    <p class="mt-1 text-slate-600">Compare cards, tables, and charts with expected outputs shown in each card.</p>
                </div>
                <div class="rounded-lg bg-slate-100 p-3 text-sm">
                    <p class="font-semibold text-slate-800">3. Export Auditable Proof</p>
                    <p class="mt-1 text-slate-600">Use section PDF exports and this manual PDF for audit or onboarding packs.</p>
                </div>
            </div>
        </header>
