...
use App\Http\Controllers\Admin\OwnerEquityController as AdminOwnerEquityController;
...
Route::middleware(['auth:sanctum', 'throttle:60,1'])->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->group(function () {
        ...
        Route::get('expenses/{id}/payments', [AdminExpenseController::class, 'payments']);
        ...
        Route::delete('payroll/{id}', [AdminPayrollController::class, 'destroy']);
