...
class FinanceService
{
    ...
    public function generateInvoiceNumber(?Carbon $invoiceDate = null): string
    {
        ...
        $maxSequence = Invoice::query()
            ...
            ->map(static function ($invoiceNumber) use ($prefix): int {
                if (! is_string($invoiceNumber) || ! str_starts_with($invoiceNumber, $prefix)) {
                    return 0;
                }
